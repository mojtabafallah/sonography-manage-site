...
<head>
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="/views/dashbassets/img/apple-icon.png">
    ...
    <link href="/views/dashboard/assets/css/nucleo-svg.css" rel="stylesheet"/>
    <!-- CSS Files -->
    <link id="pagestyle" href="/views/dashboard/assets/css/argon-dashboard.css?v=2.0.4" rel="stylesheet"/>
</head>
...
<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/argon-dashboard/pages/dashboard.html "
           target="_blank">
            <img src="/views/dashboard/assets/img/logo-ct-dark.png" class="navbar-brand-img h-100"
                 alt="main_logo">
    ...
    <div class="sidenav-footer mx-3 ">
        <div class="card card-plain shadow-none" id="sidenavCard">
            <img class="w-50 mx-auto" src="/views/dashboard/assets/img/illustrations/icon-documentation.svg"
...
<main class="main-content position-relative border-radius-lg ">
                        ...
                        <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4"
                            ...
                            <li class="mb-2">
                                <a class="dropdown-item border-radius-md" href="javascript:;">
                                    <div class="d-flex py-1">
                                        <div class="my-auto">
                                            <img src="/views/dashboard/assets/img/team-2.jpg"
                            ...
                            <li class="mb-2">
                                <a class="dropdown-item border-radius-md" href="javascript:;">
                                    <div class="d-flex py-1">
                                        <div class="my-auto">
                                            <img src="/views/dashboard/assets/img/small-logos/logo-spotify.svg"
    ...
    <div class="container-fluid py-4">
                ...
                <div class="card card-carousel overflow-hidden h-100 p-0">
                    <div id="carouselExampleCaptions" class="carousel slide h-100" data-bs-ride="carousel">
                        <div class="carousel-inner border-radius-lg h-100">
                            <div class="carousel-item h-100 active" style="background-image: url('/views/dashboard/
      ...
      background-size: cover;">
                            ...
                            <div class="carousel-item h-100" style="background-image: url('/views/dashboard/
                        ...
                        <table class="table align-items-center ">
                            ...
                            <tr>
                                <td class="w-30">
                                    <div class="d-flex px-2 py-1 align-items-center">
                                        <div>
                                            <img src="/views/dashboard/assets/img/icons/flags/US.png"
                                                 alt="Country flag">
                                        </div>
                                        <div class="ms-4">
                            ...
                            <tr>
                                <td class="w-30">
                                    <div class="d-flex px-2 py-1 align-items-center">
                                        <div>
                                            <img src="/views/dashboard/assets/img/icons/flags/DE.png"
                                                 alt="Country flag">
                                        </div>
                                        <div class="ms-4">
                                            <p class="text-xs font-weight-bold mb-0">Country:</p>
                            ...
                            <tr>
                                <td class="w-30">
                                    <div class="d-flex px-2 py-1 align-items-center">
                                        <div>
                                            <img src="/views/dashboard/assets/img/icons/flags/GB.png"
                                                 alt="Country flag">
                                        </div>
                                        <div class="ms-4">
                                            <p class="text-xs font-weight-bold mb-0">Country:</p>
                            ...
                            <tr>
                                <td class="w-30">
                                    <div class="d-flex px-2 py-1 align-items-center">
                                        <div>
                                            <img src="/views/dashboard/assets/img/icons/flags/BR.png"
                                                 alt="Country flag">
                                        </div>
                                        <div class="ms-4">
                                            <p class="text-xs font-weight-bold mb-0">Country:</p>
